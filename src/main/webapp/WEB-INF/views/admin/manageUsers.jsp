...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .td-phone    { color: var(--text-muted); font-size: 12px; }
    ...
    .badge-user {
      background: rgba(61,74,96,.35);
      color: var(--text-muted);
      border: 1px solid rgba(61,74,96,.6);
    }
    .badge-active {
...
<body>
  ...
  <main class="main">
    ...
    <div class="page-header">
      <h1>Manage Users</h1>
      <p>Search, block, or remove registered accounts.</p>
    </div>

    <!-- Search -->
    <form class="search-row" method="get" action="/admin/users">
      <div class="search-wrap">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/>
        </svg>
        <input class="search-input" name="q" placeholder="Search by username…" value="${param.q}">
      </div>
            ...
            <tr>
              ...
              <td class="actions-cell">
                <form method="post" action="/admin/users/${u.id}/toggle" class="d-inline">
                  <c:choose>
                    <c:when test="${u.blocked}">
                      <button type="submit" class="btn-toggle-unblock">Unblock</button>
                    </c:when>
                    <c:otherwise>
                      <button type="submit" class="btn-toggle-block">Block</button>
                    </c:otherwise>
                  </c:choose>
                </form>
