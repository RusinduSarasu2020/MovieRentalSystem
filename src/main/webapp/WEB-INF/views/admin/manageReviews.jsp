...
<body>
  ...
  <main class="main">
    ...
    <div class="page-header">
      <h1>User Reviews</h1>
      <p>Moderate and remove user-submitted reviews across all titles.</p>
    </div>
                ...
                <div class="star-rating">
                  <span class="stars">
                    <c:forEach begin="1" end="5" var="i">
                      <svg class="star ${i <= r.rating ? '' : 'empty'}" viewBox="0 0 24 24" fill="${i <= r.rating ? 'currentColor' : 'none'}" stroke="currentColor" stroke-width="1.8">
