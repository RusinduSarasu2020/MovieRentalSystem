...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .td-amount { font-weight: 600; color: var(--text-primary); }
...
<body>
  ...
  <main class="main">
    ...
    <div class="page-header">
      <h1>Payments</h1>
      <p>Review all transaction records across the platform.</p>
    </div>
      ...
      <table>
        ...
        <tbody>
          <c:forEach var="p" items="${payments}">
            <tr>
              <td class="td-id">#${p.paymentId}</td>
              <td class="td-user">${p.user.username}</td>
              <td class="td-movie">${p.movie.title}</td>
              <td class="td-amount">Rs ${p.amount}</td>
              <td>
                <c:choose>
              ...
              <td class="td-date">${p.createdAt}</td>
            </tr>
          </c:forEach>
